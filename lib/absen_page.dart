...
// Halaman Detail Absen Pagi dengan implementasi kamera, Cloudinary, dan Geofencing
class AbsenPagiDetailPage extends StatefulWidget {
  const AbsenPagiDetailPage({super.key});

  @override
  State<AbsenPagiDetailPage> createState() => _AbsenPagiDetailPageState();
}

class _AbsenPagiDetailPageState extends State<AbsenPagiDetailPage> {
  ...
  // Tema warna untuk absen pagi
  final Color primaryColor = const Color.fromRGBO(250, 180, 110, 1);
  final Color primaryDark = const Color.fromARGB(255, 242, 167, 76);
  final Color primaryLight = const Color.fromARGB(255, 239, 194, 150);
  final Color lightBackground = const Color(0xFFFFF8F0);
  final Color veryLightBackground = const Color(0xFFFFFBF8);
  ...
  Future<void> _checkTodayAttendance() async {
    ...
    try {
      ...
      final query = await FirebaseFirestore.instance
          ...
          .where('jenisAbsen', isEqualTo: 'pagi')
      ...
      if (query.docs.isNotEmpty) {
        ...
        print('✓ Found today\'s morning attendance record!');
        setState(() {
        ...
        print('No morning attendance record found for today');
        setState(() {
  ...
  void _showImageSourceDialog() {
    if (_hasAttendedToday) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Anda sudah absen pagi hari ini!'),
  ...
  String _getAttendanceStatus(String currentTime) {
    ...
    // Jam kerja pagi: 07:00 - 12:00
    // Terlambat jika lebih dari 07:15
    if (hour >= 8) {
  return 'Terlambat';
}
return 'Hadir';
  ...
  void _submitAbsen() async {
    ...
    try {
      ...
      debugPrint('Saving attendance data: ${absenData.toString()}');
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        if (checkQuery.docs.isNotEmpty) {
          throw Exception('Anda sudah absen pagi hari ini!');
        }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Absen pagi berhasil dicatat!'),
      ...
      if (errorMessage.contains('sudah absen')) {
        await _checkTodayAttendance();
        errorMessage = 'Anda sudah absen pagi hari ini!';
      }
            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'Anda telah melakukan absen pagi untuk hari ini. Terima kasih atas kedisiplinan Anda!',
                          style: TextStyle(
                            fontSize: 13,
                            color: Colors.green[700],
              ...
              if (!_hasAttendedToday && !_isCheckingAttendance) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [veryLightBackground, lightBackground],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                    borderRadius: BorderRadius.circular(16),
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.wb_sunny_outlined, size: 48, color: primaryColor),
                      const SizedBox(height: 12),
                      Text(
                        _currentTime,
                        style: TextStyle(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Tambahkan catatan untuk absen pagi...',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'Pastikan untuk melakukan absen sore.',
                            style: TextStyle(
                              fontSize: 12,
